  ...
  head: () => ({
    meta: [
      ...
      { title: "AYORA — Ayurvedic Wellness at Your Doorstep" },
      {
        name: "description",
        content:
          "Personalised Ayurvedic massage and wellness therapies delivered to your home across the UAE — Dubai, Abu Dhabi, Sharjah and Ajman.",
      },
      { property: "og:title", content: "AYORA — Ayurvedic Wellness at Your Doorstep" },
      {
        property: "og:description",
        content:
          "Traditional Ayurvedic care. Professional wellness. In the comfort of your home, anywhere in the UAE.",
      },
